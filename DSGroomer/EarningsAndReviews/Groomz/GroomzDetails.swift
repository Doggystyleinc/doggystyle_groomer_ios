...
class GroomzDetailsController : UIViewController, CustomAlertCallBackProtocol {
    ...
    lazy var earningsIssueReportingPopup : EarningsSupportPopup = {
        ...
        rp.groomzDetailsController = self
        
        return rp
    }()
    
    lazy var groomzCollection : GroomzCollectionView = {
        
        let layout = UICollectionViewFlowLayout()
        layout.scrollDirection = .vertical
        let gcv = GroomzCollectionView(frame: .zero, collectionViewLayout: layout)
        gcv.groomzDetailsController = self
    ...
    func addViews() {
        ...
        self.groomzCollection.topAnchor.constraint(equalTo: self.centerDataContainer.bottomAnchor, constant: 20).isActive = true
        self.groomzCollection.leftAnchor.constraint(equalTo: self.view.leftAnchor, constant: 0).isActive = true
